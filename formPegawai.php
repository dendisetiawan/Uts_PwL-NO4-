<?php
require_once 'datapegawai.php';
$ar_kondisi = ['Baru','lama'];
$obj = new Produk();
$rs = $obj->datapegawai();
?>
...
<form method="POST" action="controllers/produkController.php">
  <div class="form-group row">
    <label for="kode" class="col-4 col-form-label">id pegawai</label> 
    <div class="col-8">
  ...
  <div class="form-group row">
    <label for="harga" class="col-4 col-form-label">email </label> 
    <div class="col-8">
  ...
  <div class="form-group row">
    <label for="jenis" class="col-4 col-form-label">Agama </label> 
    <div class="col-8">
